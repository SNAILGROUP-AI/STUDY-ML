...
<details><summary><h4>알고리즘 채택</h4></summary>

- **주어진 데이터 세트에 적합한 분석 방법 선택**
    - 반응변수가 범주형 변수인 경우 : 분류분석
    - 반응변수가 수치형 변수인 경우 : 회귀분석

- **주어진 데이터 세트를 분석하기 적합한 알고리즘 선정**
    - 분류분석 알고리즘의 예시
...
<details><summary><h4>전처리</h4></summary>
...
<details><summary><h4>훈련, 검증 및 평가</h4></summary>

- **훈련용 데이터 세트를 활용하여 인스턴스 훈련**

- **검증용 데이터 세트를 활용하여 인스턴스 검증**
    - 검증 절차를 필수로 거쳐야 하는 것은 아님

- **평가용 데이터 세트를 활용하여 인스턴스 성능 평가**
